...
var TEMPLATE_END = "<button id='quick-edit-outfocus' style='width: 0; height: 0'></button></div>"
...
class QuickeditManager extends EventEmitter {
  ...
  open (view, x, y) {
    ...
    Coord.coordRevTransform(editor.canvas.zoomFactor, GridFactor.NO_GRID, position)
    this.close()
  ...
  render (editor, rect, view, quickedit) {
    Coord.coordTransform2(editor.canvas.zoomFactor, GridFactor.NO_GRID, rect)
