...
class KeymapManager {
  ...
  formatKeyDescriptor (descriptor) {
    ...
    if (process.platform === 'darwin') {
      ...
      displayStr = displayStr.replace('cmdctrl', '\u2318') // Cmd > command symbol
      ...
      displayStr = displayStr.replace('delete', '⌫')       // Delete > backspace symbol (Backspace acts like delete in macOS)
      displayStr = displayStr.replace('up', '↑')           // Up > up arrow
      displayStr = displayStr.replace('down', '↓')         // Down >  down arrow
    } else {
      displayStr = descriptor.replace('cmdctrl', 'Ctrl')   // Ctrl
      displayStr = displayStr.replace('ctrl', 'Ctrl')      // Ctrl
      displayStr = displayStr.replace('shift', 'Shift')    // Shift
      displayStr = displayStr.replace('alt', 'Alt')        // Alt
      displayStr = displayStr.replace('space', 'Space')    // Space
      displayStr = displayStr.replace('enter', 'Enter')    // Enter
      displayStr = displayStr.replace('delete', 'Delete')  // Delete
      displayStr = displayStr.replace('up', '↑')           // Up > up arrow
      displayStr = displayStr.replace('down', '↓')         // Down >  down arrow
