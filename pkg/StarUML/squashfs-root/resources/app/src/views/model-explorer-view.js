...
class ModelExplorerView extends EventEmitter {
  ...
  _setupSettingsMenu () {
    // Register Commands
    app.commands.register('explorer:sort-by-added', () => { this._handleSortByAdded() })
    app.commands.register('explorer:sort-by-name', () => { this._handleSortByName() })
    app.commands.register('explorer:show-stereotype-text', () => { this._toggleStereotypeText() })
