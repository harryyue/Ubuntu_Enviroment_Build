 ...
 */
function handleApplyProfile (fullPath) {
...
function handleOpenUpCompartmentItem (options) {
  ...
  if (idx === 0 || currentCompartment instanceof type.UMLNameCompartmentView) {
    ...
    if (compartmentIdx > 0) {
      ...
      if (prevCompartment) {
        let target = prevCompartment.subViews[prevCompartment.subViews.length - 1]
    ...
    if (idx > 0) {
      let target = currentCompartment.subViews[idx - 1]
      if (target) {
        _.defer(() => { app.quickedits.open(target) })
      }
    }
...
function handleOpenDownCompartmentItem (options) {
  ...
  let compartmentIdx = compartments.indexOf(currentCompartment)
  let idx = currentCompartment.subViews.indexOf(compartmentItem)
  if (idx === currentCompartment.subViews.length - 1 || currentCompartment instanceof type.UMLNameCompartmentView) {
    ...
    if (compartmentIdx < compartments.length - 1) {
      ...
      if (nextCompartment) {
        let target = nextCompartment.subViews[0]
    ...
    if (idx < currentCompartment.subViews.length - 1) {
      let target = currentCompartment.subViews[idx + 1]
      if (target) {
        _.defer(() => { app.quickedits.open(target) })
      }
...
app.commands.register('uml:apply-profile.uml-standard', handleApplyUMLStandardProfile)
...
app.commands.register('format:stereotype-none', _.partial(handleStereotypeDisplay, UMLGeneralNodeView.SD_NONE))
app.commands.register('format:stereotype-label', _.partial(handleStereotypeDisplay, UMLGeneralNodeView.SD_LABEL))
app.commands.register('format:stereotype-decoration', _.partial(handleStereotypeDisplay, UMLGeneralNodeView.SD_DECORATION))
app.commands.register('format:stereotype-decoration-label', _.partial(handleStereotypeDisplay, UMLGeneralNodeView.SD_DECORATION_LABEL))
app.commands.register('format:stereotype-icon', _.partial(handleStereotypeDisplay, UMLGeneralNodeView.SD_ICON))
app.commands.register('format:stereotype-icon-label', _.partial(handleStereotypeDisplay, UMLGeneralNodeView.SD_ICON_LABEL))
app.commands.register('format:word-wrap', _.partial(handleToggleProperty, 'wordWrap'))
app.commands.register('format:show-visibility', _.partial(handleToggleProperty, 'showVisibility'))
app.commands.register('format:show-namespace', _.partial(handleToggleProperty, 'showNamespace'))
app.commands.register('format:show-property', _.partial(handleToggleProperty, 'showProperty'))
app.commands.register('format:show-type', _.partial(handleToggleProperty, 'showType'))
app.commands.register('format:show-multiplicity', _.partial(handleToggleProperty, 'showMultiplicity'))
app.commands.register('format:show-operation-signature', _.partial(handleToggleProperty, 'showOperationSignature'))
app.commands.register('format:suppress-attributes', _.partial(handleToggleProperty, 'suppressAttributes'))
app.commands.register('format:suppress-operations', _.partial(handleToggleProperty, 'suppressOperations'))
app.commands.register('format:suppress-receptions', _.partial(handleToggleProperty, 'suppressReceptions'))
app.commands.register('format:suppress-literals', _.partial(handleToggleProperty, 'suppressLiterals'))
